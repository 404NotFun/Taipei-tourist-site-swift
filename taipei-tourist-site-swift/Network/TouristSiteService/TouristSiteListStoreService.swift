//
//  TouristSiteListStoreService.swift
...
public protocol TouristSiteListStoreService {
    var touristSiteList: [TouristSite]? { get }
    func updateTouristSiteList(with newTouristSiteList: [TouristSite])
}

public struct DefaultTouristSiteListStoreService : TouristSiteListStoreService {
    public var touristSiteList: [TouristSite]?
    ...
    public func updateTouristSiteList(with newTouristSiteList: [TouristSite]) {
...
public struct MockTouristSiteListStoreService : TouristSiteListStoreService {
    public var touristSiteList: [TouristSite]? {
        return []
    }
