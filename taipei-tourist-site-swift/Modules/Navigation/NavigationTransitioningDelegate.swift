//
//  NavigationTransitioningDelegate.swift
...
final public class NavigationTransitioningDelegate: UIPercentDrivenInteractiveTransition {
    ...
    public var presentingViewController: UIViewController! {
        didSet {
            exitingEdgeGesture = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(NavigationTransitioningDelegate.handleExitingEdgeGesture(_:)))
...
extension NavigationTransitioningDelegate : UIViewControllerTransitioningDelegate {
...
extension NavigationTransitioningDelegate : UIViewControllerAnimatedTransitioning {
